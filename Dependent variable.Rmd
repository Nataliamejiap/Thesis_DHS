...
model <- pglm(inedu ~ age + gender, model = "pooling", family = binomial("probit"), data = dependentv)
...
```{r}
#Merging the perentedu with the dependent variable inedu
...
```{r}
#Independent variable: househol (income)
