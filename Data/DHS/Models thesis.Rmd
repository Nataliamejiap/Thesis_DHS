...
model_inter <- glm(dropouts ~ gender + resi + region + wealth + educ_head:mom_marital, data = final_data, family = "binomial")
...
probs <- ggpredict(model_inter, 
                   terms = c("mom_marital", "educ_head"))
...
probs %>% 
    ...
    geom_errorbar(aes(ymin = conf.low, 
                  ...
                  position = position_dodge(width = 0.2)) +
  theme_minimal() +
  labs(title = "Figure 1. Predicted probabilities of dropouts by mothers´ marital status and interaction of level of education head of household",
