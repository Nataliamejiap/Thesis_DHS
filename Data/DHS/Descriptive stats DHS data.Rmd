...
head_edu <- data.frame("Variables" =
                            c("0-No education", 
                              ...
                              "3-Higher",
                              "4-Don´t know"),
                          "Dropout" = c(15.7, 36.1,32.2,15.2,0.8),
                          "Attending school" = c(12.1, 33.3, 34.3, 19.6, 0.7))
...
kbl(DATA, 
    ...
    footnote = "Source: DHS Colombia 2015, own estimates") %>%
  pack_rows("Level of education head household", 1, 5) %>%
  pack_rows("Wealth status", 6, 10) %>%
  pack_rows("Mom marital status", 11, 14) %>%
  pack_rows("Father marital status", 15, 18) %>%
  kable_classic(full_width = F, html_font = "Cambria") 
