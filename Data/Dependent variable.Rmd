...
#Subsetting the data to the members 1 and 2 of the household (head of household and partner)
...
model <- pglm(inedu ~ educ_dad + dad_house + mom_house + age + gender, model = "pooling", family = binomial("probit"), data = model01)
